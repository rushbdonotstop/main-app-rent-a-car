...
#https://github.com/hashedin/gps-simulator/blob/master/vehicles.py
...
if __name__ == '__main__':
    ...
    print("")
    print(
        "Hint: To visualize this route, copy the polyline and paste it in the textfield called Encoded Polyline over here - https://developers.google.com/maps/documentation/utilities/polylineutility")
